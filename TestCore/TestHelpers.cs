...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        [TestCase("HashToShort", "IunRhDKa+fWo8+4/Qfj7Pg==.kDxZnUQHCZun6gLIE6d9oeULLRIuRmxmH2QKJv2IM08")]
        [TestCase("WrongHash", "verkeerdeSalt.verkeerdeHash")]
        [TestCase("WrongPassword", "sxnIcZdYt8wC8MYWcQVQjQ==.FKd5Z/jwxPv3a63lX+uvQ0+P7EuNYZybvkmdhbnkIHA=")]
